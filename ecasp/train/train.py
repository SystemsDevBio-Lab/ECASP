...
Date: 2025-03-20
Description: Train an ECASP model.
"""
...
import ecasp.create_data.paralogs as paralogs
from ecasp.transfer.transfer import (
    load_tissue_entries,
...
def train_multi_tissue(args):
    ...
    model, optimizer, scheduler, params, _ = initialize_model_and_optim(
        ...
        lr=args.lr, film_lr_mult=args.film_lr_mult, head_dropout=args.head_dropout,
...
def train(args):
    print("Running ECASP with 'train' mode")
